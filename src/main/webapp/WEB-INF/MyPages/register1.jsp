...
<body>
<jsp:include page="/WEB-INF/MyPages/components/header.jsp" ></jsp:include>
<jsp:include page="/WEB-INF/MyPages/components/topbar.jsp" ></jsp:include>
...
<jsp:include page="/WEB-INF/MyPages/components/footer.jsp"></jsp:include>
</body>
</html>